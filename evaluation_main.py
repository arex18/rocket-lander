    ...
    def execute_evaluation(self, env, controller, initial_states: list, initial_forces: list, disturbances: list, impulses: list):
        ...
        with open('logfile.txt', 'w') as log:
            for i in range(number_of_tests):
                ...
                log.write(f'Number of bodies present: {len(env.world.bodies)}')
                while not done:
                    steps += 1
                    log.write(f'Step: {steps}, ')
                    log.write(f'Legs are here: {[leg.position[1] for leg in env.legs]}\n')
                    if env.check_landing_flag:
                        log.write(f'Checking for Landing:')
                        log.write(f'left contact: {s[LEFT_GROUND_CONTACT]}, right contact: {s[RIGHT_GROUND_CONTACT]}\n')
                    ...
                    if a.shape == (len_actions,):
                        ...
                        control_horizon = self.controller_settings.get('control_horizon')
                        if a.shape[0] < control_horizon:
                            range_cntr = a.shape[0]
                        else:
                            range_cntr = control_horizon
                        if control_horizon:
                            for j in range(range_cntr):
...
def evaluate_low_discretization_q_learning_function_approximation():
    file_path = 'C://Users//suntz//rocket_lander//rocket_proj//rocket-lander-master//control_and_ai//evaluation_scripts//rl_q_learning//low_discretization'
    load_path = 'C://Users//suntz//rocket_lander//rocket_proj//rocket-lander-master//control_and_ai//function_approximation_rl' \
...
def evaluate_high_discretization_q_learning_function_approximation():
    file_path = 'C://Users//suntz//rocket_lander//rocket_proj//rocket-lander-master//control_and_ai//evaluation_scripts//rl_q_learning//high_discretization'
    load_path = 'C://Users//suntz//rocket_lander//rocket_proj//rocket-lander-master//control_and_ai//function_approximation_rl' \
...
def evaluate_high_discretization_q_learning_function_approximation_longer_state():
    file_path = 'C://Users//suntz//rocket_lander//rocket_proj//rocket-lander-master//control_and_ai//evaluation_scripts//rl_q_learning//high_discretization_longer_state'
    load_path = 'C://Users//suntz//rocket_lander//rocket_proj//rocket-lander-master//control_and_ai//function_approximation_rl' \
                '//rl_linear_function_approximation_high_function_discretization_5000_episodes_trained_at_once_original.p'
...
def evaluate_normalized_normal_state_ddpg():
    ...
    load_path = 'C://Users//suntz//rocket_lander//rocket_proj//rocket-lander-master//control_and_ai//DDPG//model_normal_state'

    file_path = 'C://Users//suntz//rocket_lander//rocket_proj//rocket-lander-master//control_and_ai//DDPG//model_normal_state'
...
if __name__ == "__main__":
    ...
    # evaluate_low_discretization_q_learning_function_approximation() # evaluate_normalized_normal_state_ddpg()
    # evaluate_high_discretization_q_learning_function_approximation()
    #  # evaluate_MPC() # evaluate_high_discretization_q_learning_function_approximation_longer_state()
