 ...
 * Created On: Thu Oct 17 15:42:43 2013.
***************************************************/
#ifdef WMI_WINNT
...
static void fp(long N, double T, double *Y, double *YP)
{
	...
	Z[9] = -(Z[8]+Z[7])-0.002;
	Z[10] = 0.00035*Z[2];
	Z[11] = Z[10]-0.0012*Z[3];
	Z[12] = Z[11]*Z[6];
	Z[13] = Z[9]*Z[0]+Z[12];
	Z[2] = Z[6]*Z[5]+Z[0]*Z[2];
	Z[5] = 0.35*Z[2];
	Z[9] = Z[9]*Z[6]-Z[11]*Z[0];
	Z[11] = Z[4]*Z[13];
	Z[14] = Z[5]*Z[9];
	M[0] = Z[11]-Z[14]+0.001;
	...
	Z[2] = 0.00035*Z[2];
	Z[15] = -Z[2]+0.0012*Z[12];
	Z[16] = Z[4]*Z[8];
	Z[17] = Z[5]*Z[15];
	M[1] = Z[16]-Z[17]+0.001;
	Z[18] = 0.001*Z[4];
	Z[19] = -0.001*Z[5];
	M[2] = Z[4]*Z[18]-Z[5]*Z[19]+0.001;
	Z[20] = Y[8];
	Z[21] = Y[1]+Y[3];
	Z[22] = -0.6*Z[12];
	Z[23] = Y[1]+Y[3]+Y[5];
	...
	Z[25] = Z[24]*Z[6];
	Z[26] = Z[21]*Z[22];
	Z[23] = 0.001*Z[23]*Z[23];
	Z[27] = Z[23]*Z[5];
	Z[28] = -Z[27]-0.002*(Z[25]+Z[26]);
	Z[29] = -0.6*(Z[0]*Z[1]+Z[6]*Z[3]);
	Z[24] = Z[24]*Z[0];
	Z[21] = Z[21]*Z[29];
	Z[23] = Z[23]*Z[4];
	Z[30] = -Z[23]+0.002*(Z[24]-Z[21]);
	Z[31] = Z[4]*Z[28];
	Z[32] = Z[5]*Z[30];
	V[0] = Z[32]-Z[20]-Z[31];
	Z[1] = 0.0018*Z[1];
	...
	Z[9] = -(Z[9]+Z[33])*Z[22];
	Z[13] = (Z[34]+Z[13])*Z[29];
	M[3] = Z[9]+Z[13]+Z[11]-Z[14]+0.002;
	Z[35] = -(Z[1]+Z[7])*Z[0]+Z[10];
	Z[2] = -Z[2]+0.0018*Z[12];
	Z[8] = (Z[35]+Z[8])*Z[29];
	Z[12] = -(Z[15]+Z[2])*Z[22];
	M[4] = Z[12]+Z[8]+Z[16]-Z[17]+0.002;
	M[5] = (Z[4]+2.*Z[29])*Z[18]-(Z[5]+2.*Z[22])*Z[19]+0.001;
	Z[15] = Y[7];
	Z[26] = 0.003*Z[26];
	Z[36] = -(Z[26]+Z[27])-0.004*Z[25];
	Z[21] = 0.003*Z[21];
	Z[37] = -(Z[21]+Z[23])+0.004*Z[24];
	Z[30] = (Z[30]+Z[37])*Z[22];
	Z[28] = -(Z[36]+Z[28])*Z[29];
	V[1] = Z[30]+Z[28]+Z[32]-Z[31]-Z[15]-Z[20];
	Z[1] = -(Z[1]+Z[7])-0.005;
	M[6] = -(Z[33]+Z[6]*Z[1]-Z[3])*Z[6]+Z[9]-(Z[34]+Z[0]*Z[1]+Z[10])*Z[0]+Z[13]+Z[11]-Z[14]+0.003;
	M[7] = Z[12]+Z[8]+Z[16]-Z[17]-2.*(Z[0]*Z[35]+Z[6]*Z[2])+0.002;
	M[8] = -(-Z[4]+2.*(Z[0]-Z[29]))*Z[18]-(Z[5]+2.*(Z[6]+Z[22]))*Z[19]+0.001;
	V[2] = Z[30]+Z[28]-(Z[26]+Z[27]-Z[36]+0.005*Z[25])*Z[0]-(Z[21]+Z[23]-Z[37]-0.005*Z[24])*Z[6]+Z[32]-Z[31]-Y[6]-Z[15]-Z[20];
	DecompCInc(3,M,3,P);
	SolveCInc(3,M,3,P,V);
	YP[1] = V[0];
	YP[3] = V[1];
