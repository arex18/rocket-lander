 ...
 * Created On: Wed Jan 15 12:11:09 2014.
***************************************************/
#ifdef WMI_WINNT
...
static void fp(long N, double T, double *Y, double *YP)
{
	...
	Z[25] = Z[20]*Z[21];
	Z[26] = Z[22]*Z[2];
	Z[27] = -Z[26]-2.*(Z[24]+Z[25]);
	Z[28] = -0.6*(Z[0]*Z[1]+Z[6]*Z[3]);
	Z[23] = Z[23]*Z[0];
	Z[20] = Z[20]*Z[28];
	Z[22] = Z[22]*Z[4];
	Z[29] = -Z[22]+2.*(Z[23]-Z[20])-9.81;
	Z[30] = Z[4]*Z[27];
	Z[31] = Z[2]*Z[29];
	V[0] = Z[31]-Z[19]-Z[30]-Y[5];
	Z[1] = 1.8*Z[1];
	Z[32] = -(Z[1]+Z[7])-4.;
	Z[3] = Z[10]-1.8*Z[3];
	Z[10] = Z[6]*Z[3];
	...
	Z[35] = Y[7];
	Z[25] = 3.*Z[25];
	Z[36] = -(Z[25]+Z[26])-4.*Z[24];
	Z[20] = 3.*Z[20];
	Z[37] = -(Z[20]+Z[22])+4.*Z[23]-19.62;
	Z[29] = (Z[29]+Z[37])*Z[21];
	Z[27] = -(Z[36]+Z[27])*Z[28];
	V[1] = Z[29]+Z[27]+Z[31]-Z[30]-Z[35]-Z[19]-Y[3];
	Z[1] = -(Z[1]+Z[7])-5.;
	...
	V[2] = Z[29]+Z[27]-(Z[25]+Z[26]-Z[36]+5.*Z[24])*Z[0]-(Z[20]+Z[22]-Z[37]-5.*Z[23]+29.43)*Z[6]+Z[31]-Z[30]-Y[6]-Z[35]-Z[19]-Y[1];
	DecompCInc(3,M,3,P);
	SolveCInc(3,M,3,P,V);
	YP[1] = V[0];
	YP[3] = V[1];
